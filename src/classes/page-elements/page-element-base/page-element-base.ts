...
import { Style, StyleTags } from '@/classes/base/style/style';
...
export class PageElement implements PageElementInterface {
  #_name: string; //** name of the component  */
  #_ref: string; //**  unique ref of this component in the Dom */
  #_componentHTMLTag: string; //** component tag */
  #_isContainer: boolean; //** can contain  other elements */
  #_styles: Style[]; //** css styles */
  #_parent!: PageContainer; //** parent Object */
  #_parentRef: string; //** string ref to the parent */
  #_classDefinition: string; //** String of tailwind classes to be applied to an element */
  #_type: ComponentTypesString; //** what is this component as in image text etc */
  #_dimension: ADimension;
  #_location: ALocation;
  #_actionEvent: AnActionEvent; //** if this component support events ActionEvent defines the event type and action */
  #_content: string;
  #classList: string[] = [];
  #_isAbsolute = false;
