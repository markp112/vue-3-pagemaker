...
export class ContainerEditorBuilder implements SidebarPanelBuilderInterface {
  private buildJustification(): SidebarToolbar {
    ...
    sideBarToolbar.addIcon(
      "align_vertical_left-32.png",
      "justify-start",
      "Align content to start"
    );
    sideBarToolbar.addIcon(
      "align_horizontal_center-32.png",
      "justify-center",
      "Center content"
    );
    sideBarToolbar.addIcon(
      "space_evenly_horizontal-32.png",
      "justify-around",
      "Align with space around"
    );
    sideBarToolbar.addIcon(
      "icons8-add-white-space-32.png",
      "justify-between",
      "Align with space between"
    );
    sideBarToolbar.addIcon(
      "align_vertical_right-32.png",
      "justify-end",
      "Align to end"
    );
  ...
  private buildVerticalAlignment(): SidebarToolbar {
    ...
    sideBarToolbar.addIcon(
      "align_horizontal_top-32.png",
      "items-start",
      "Align to top"
    );
    sideBarToolbar.addIcon(
      "distribute_vertical_center.png",
      "items-center",
      "Center vertically"
    );
    sideBarToolbar.addIcon(
      "align_horizontal_bottom-32.png",
      "items-end",
      "Align to end"
    );
    return sideBarToolbar;
